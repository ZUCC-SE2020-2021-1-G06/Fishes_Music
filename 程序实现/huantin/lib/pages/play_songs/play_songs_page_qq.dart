...
class PlaySongsPageQQ extends StatefulWidget {
  @override
  _PlaySongsPageState createState() => _PlaySongsPageState();
}

class _PlaySongsPageState extends State<PlaySongsPageQQ>
          ...
          children: <Widget>[
            ...
            AppBar(
              ...
              title: Column(
                ...
                children: <Widget>[
                  Text(
                    model.curSongQQ.name,
                    style: commonWhiteTextStyle,
                  ),
                  Text(
                    model.curSongQQ.artists,
...
//                  Utils.showToast("暂不支持收藏歌曲");
                  ...
                  model.addMySongQQ(context, model2.localUser.userId, model.curSongQQ);
                }
              },
            );
          }),
