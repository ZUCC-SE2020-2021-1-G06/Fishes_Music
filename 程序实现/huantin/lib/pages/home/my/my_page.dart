...
import 'package:huantin/pages/home/my/playlist_title.dart';
...
import 'package:huantin/widgets/widget_create_play_list.dart';
import 'package:huantin/widgets/widget_play_list_menu.dart';
...
class _MyPageState extends State<MyPage> with AutomaticKeepAliveClientMixin {
  Map<String, String> topMenuData = {
    ...
    '自建歌单': 'images/icon_broadcast.png',
  };
...
//  顶部信息栏
  ...
  /// 构建「我创建的歌单」
  Widget _buildCjPlayListItem(List<Playlist> data) {
              ...
              child: IconButton(
                ...
                onPressed: () {
                  showModalBottomSheet<Playlist>(
                      ...
                      backgroundColor: Colors.transparent).then((v) {
                      if (v != null) {
                      // 1 为删除
                      if(v.type == 1) {
                      ...
                      if(v.type == 2) {
                        ...
                        _playListModel.editPlayList(curPlayList,v.name,v.description);
                      }
                    }
                  });
                },
  ...
  /// 构建「收藏的歌单」
  Widget _buildScPlayListItem(List<Playlist> data) {
    return ListView.builder(
        shrinkWrap: true,
        physics: NeverScrollableScrollPhysics(),
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            subtitle: Text(
              '${curPlayList.trackCount}首  by ${curPlayList.creator.nickname}',
              style: smallGrayTextStyle,
            ),
            leading: RoundedNetImage(
              '${curPlayList.coverImgUrl}?param=150y150',
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Offstage(
          ...
          child: _buildCjPlayListItem(_playListModel.selfCreatePlayList),
        ),
        PlaylistTitle(
          "收藏的歌单", _playListModel.collectPlayList.length, () {
            setState(() {
        ...
        Offstage(
          ...
          child: _buildScPlayListItem(_playListModel.collectPlayList),
        ),
      ],
    );
  }
